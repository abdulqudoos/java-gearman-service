...
public abstract class Gearman implements GearmanService{
	...
	public static Gearman createGearman() {
		...
		/*
		 * This abstract factory method creates a Gearman instance from the class name defined
		 * in the gearman properties (org.gearman.GearmanProperies). The implementation must
		 * have a default constructor
		 */
		
		try {
			final String implClassname = GearmanProperty.getPropertyValue(GearmanProperty.GEARMAN_CLASSNAME);
