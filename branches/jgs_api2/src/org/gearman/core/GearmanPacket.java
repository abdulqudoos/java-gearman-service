...
public final class GearmanPacket {
	...
	public static final GearmanPacket createTEXT(String packet) {
		...
		return new GearmanPacket(Magic.REQ, Type.TEXT, packet.getBytes(GearmanImplConstants.CHARSET));
	}
	...
	public static final GearmanPacket createCAN_DO(final String funcName) {
		return new GearmanPacket(Magic.REQ, Type.CAN_DO, funcName.getBytes(GearmanImplConstants.CHARSET));
	}
	...
	public static final GearmanPacket createCANT_DO(final String funcName) {
		return new GearmanPacket(Magic.REQ, Type.CANT_DO, funcName.getBytes(GearmanImplConstants.CHARSET));
	}
	...
	public static final GearmanPacket createSUBMIT_JOB(final String funcName, final byte[] uID, final byte[] data) {
		return new GearmanPacket(Magic.REQ, Type.SUBMIT_JOB, funcName.getBytes(GearmanImplConstants.CHARSET), uID, data);
	}
	...
	public static final GearmanPacket createSUBMIT_JOB_HIGH(final String funcName, final byte[] uID, final byte[] data) {
		return new GearmanPacket(Magic.REQ, Type.SUBMIT_JOB_HIGH, funcName.getBytes(GearmanImplConstants.CHARSET), uID, data);
	}
	public static final GearmanPacket createSUBMIT_JOB_HIGH_BG(final String funcName, final byte[] uID, final byte[] data) {
		return new GearmanPacket(Magic.REQ, Type.SUBMIT_JOB_HIGH_BG, funcName.getBytes(GearmanImplConstants.CHARSET), uID, data);
	}
	public static final GearmanPacket createSUBMIT_JOB_LOW(final String funcName, final byte[] uID, final byte[] data) {
		return new GearmanPacket(Magic.REQ, Type.SUBMIT_JOB_LOW, funcName.getBytes(GearmanImplConstants.CHARSET), uID, data);
	}
	public static final GearmanPacket createSUBMIT_JOB_LOW_BG(final String funcName, final byte[] uID, final byte[] data) {
		return new GearmanPacket(Magic.REQ, Type.SUBMIT_JOB_LOW_BG, funcName.getBytes(GearmanImplConstants.CHARSET), uID, data);
	}
	...
	public static final GearmanPacket createWORK_STATUS(final Magic magic, final byte[] jobHandle, final long numerator, final long denominator) {
		final byte[] num = Long.toString(numerator).getBytes(GearmanImplConstants.CHARSET);
		final byte[] den = Long.toString(denominator).getBytes(GearmanImplConstants.CHARSET);
	...
	public static final GearmanPacket createSET_CLIENT_ID(String id) {
		return new GearmanPacket(Magic.REQ, Type.SET_CLIENT_ID, id.getBytes(GearmanImplConstants.CHARSET));
	}
	public static final GearmanPacket createCAN_DO_TIMEOUT(final String funcName, final long timeout) {
		...
		return new GearmanPacket(Magic.REQ, Type.CAN_DO_TIMEOUT, funcName.getBytes(GearmanImplConstants.CHARSET), Long.toString(timeout).getBytes(GearmanImplConstants.CHARSET));
	}
	
	public static final GearmanPacket createJOB_ASSIGN(final byte[] jobHandle, final String funcName, final byte[] data) {
		return new GearmanPacket(Magic.RES, Type.JOB_ASSIGN, jobHandle, funcName.getBytes(GearmanImplConstants.CHARSET), data);
	}
	...
	public static final GearmanPacket createJOB_ASSIGN_UNIQ(final byte[] jobHandle, final String funcName, final byte[] uniqueID, final byte[] data) {
		return new GearmanPacket(Magic.RES, Type.JOB_ASSIGN_UNIQ, jobHandle, funcName.getBytes(GearmanImplConstants.CHARSET), uniqueID, data);
	}
