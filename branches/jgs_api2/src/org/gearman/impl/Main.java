...
class Main {
	...
	private static String HELP = 
		GearmanImplConstants.VERSION + "\n" +
		"\n" +
		"usage:\n" +
		"java [jvm options] -jar "+GearmanImplConstants.VERSION+".jar [server options]\n" +
		"\n" +
		"Options:\n" +
	...
	private static final void printVersion() {
		System.out.println(GearmanImplConstants.VERSION);
		System.exit(0);
	}
	...
	private int port = GearmanImplConstants.PORT;
