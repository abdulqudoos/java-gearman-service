...
public final class GearmanImpl extends Gearman {
	...
	public GearmanImpl(int coreThreads) throws IOException {
		...
		final ThreadPoolExecutor pool = new ThreadPoolExecutor(coreThreads, Integer.MAX_VALUE, GearmanImplConstants.THREAD_TIMEOUT, TimeUnit.MILLISECONDS, new SynchronousQueue<Runnable>());
	...
	public String getVersion() {
		return GearmanImplConstants.VERSION;
	}
