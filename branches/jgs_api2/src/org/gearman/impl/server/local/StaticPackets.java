...
final class StaticPackets {
	...
	public static final GearmanPacket ERROR_BAD_MAGIC = new GearmanPacket(
			Magic.RES, Type.ERROR, "bad_magic".getBytes(), "Request magic expected".getBytes(GearmanImplConstants.CHARSET));
	...
	public static final GearmanPacket TEXT_VERSION = GearmanPacket.createTEXT(GearmanImplConstants.VERSION);
}
