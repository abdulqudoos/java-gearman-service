...
public interface GearmanJobHandler {
	 ...
	 */
	public void callbackWarning(GearmanSubmittal submittal, byte[] warning);
	 ...
	 *            Information to send on the data callback channel
	 */
	public abstract void callbackData(GearmanSubmittal submittal, byte[] data);
	 ...
	 * 		completed
	 */
	public abstract void callbackStatus(GearmanSubmittal submittal, long numerator, long denominator);
	 ...
	 */
	public void onSuccess(GearmanSubmittal job, byte[] data);
	 ...
	 */
	public void onFailure(GearmanSubmittal job, GearmanJobFailureType failureType);
}
